...
Moodle has a file size limit of 100MB on any file submission. Files exceeding the size limit cannot be accepted. Files sent via OneDrive or any external file sharing software cannot be accepted. You can find more information about how to create and submit your assessment here 

Assessment Type: Report	Assessment Weighting: 50% of module mark	Length: 2,000 words (+10%) excluding references and citations.
Assignment Task 
...
1.	Evaluation of the financial performance ratio results (Approx. 600 words) 

2.	Evaluation of the financial position ratio results (Approx. 600 words)

3.	In relation to planning the audit next year, with Debenhams Group Plc, discuss any potential audit risks that might arise impacting the forthcoming year results (Approx. 500 words). You must use the correct terminology and link newspaper articles as evidence to support your discussions.
...
Analysis of financial position	25 marks
Discussion on the potential audit risks	14 marks
Conclusion	10 marks
Presentation	15 marks
Table of ratios	6 marks
...
1.	LO2 - Apply the principles and procedures of International Financial Reporting Standards (IFRS) and International Standards on Auditing (ISAs) to business scenarios. 
2.	LO4 - Interpret financial statements using key financial ratios
Assurance of Learning (AoL)

AoL Traits assessed

1.	Our graduates will apply critical thinking to practical and theoretical problems 
2.	Our graduates will be effective communicators using a range of media 
3.	Our graduates will demonstrate professional and commercial/corporate awareness
...
Your submission will be marked using the stepped marking scheme. You can find more information about it in our Verification, Marking and Moderation Policy. The marking rubric is used to evaluate your work against specific marking criteria. 
...
Analysis of financial position                       LO4 & PLO 4.1.1 /4.1.2	A focussed and critical analysis of the key financial position ratios	No evaluation of financial position	Partial evaluation of financial position	Adequate evaluation of financial position however more descriptive	Good evaluation of financial position with an effort made with criticality	Very good critical evaluation of financial position 	Excellent critical evaluation of financial position	Exceptional critical evaluation of financial position	25.00%
...
This is how you access your feedback

Grade Mark: Your assessment feedback is provided through Grade Mark. Please click the grey pencil icon next to your grade, as displayed on the picture below. This will take you to a page which shows your feedback pdf sheet, which can be opened to view full feedback and marks for each section of the assignment.
